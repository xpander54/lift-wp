...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
        ...
        array(
            'name'     				=> 'WPBakery Visual Composer for Astra theme', // The plugin name
            'slug'     				=> 'astra_js_composer', // The plugin slug (typically the folder name)
            'source'   				=> get_template_directory() . '/vendor/plugins/astra_js_composer.zip', // The plugin source
