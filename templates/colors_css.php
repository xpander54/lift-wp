...
.g-pagination-item:hover {
	box-shadow: 0 0 0 20px <?php echo ($smof_data['main_border'] != '')?$smof_data['main_border']:'#dce2e5'; ?> inset;
	}
...
.color_alternate .g-pagination-item:hover {
	box-shadow: 0 0 0 20px <?php echo ($smof_data['alt_border'] != '')?$smof_data['alt_border']:'#d0d6d9'; ?> inset;
	}
